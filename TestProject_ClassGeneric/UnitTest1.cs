using static Al_JabbarTransLibraries.ClassGeneric;
using static Al_JabbarTransLibraries.ClassTableDriven;
using System;
using Al_JabbarTransLibraries;
using NUnit.Framework;

namespace TestProject_ClassGeneric
{
    namespace Al_JabbarTransLibraries.Tests
    {
        [TestFixture]
        public class ClassGenericTests
        {
            private ClassGeneric _classGeneric;

            [SetUp]
            public void Setup()
            {
                _classGeneric = new ClassGeneric();
            }
